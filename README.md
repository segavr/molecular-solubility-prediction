...
- Input features: RDKit descriptors such as molecular weight (MW), LogP, topological polar surface area (TPSA), number of H-bond donors (HBD), number of H-bond acceptors (HBA), and number of rotatable bonds.
...
6. Evaluate models with RMSE, MAE, t set.
...
These numbers show that the non-linear Random Forest model fits the ESOL data bee linear model.
...
I plan to reference these figures in a short report-style notebook and in future applications.
